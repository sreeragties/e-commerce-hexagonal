...
public final class KafkaEventTypes {
    ...
    public static final String ORDER_PAYMENT_PROCESSED = "order.payment.processed";
    ...
    public static final String ORDER_STAGED_FOR_SHIPPING = "order.staged.for.shipping";
